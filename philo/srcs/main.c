...
/*   Updated: 2023/10/24 21:20:20 by fvastena         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	threading(t_data *datas)
{
	...
	while (i < datas->nb_philos)
	{
		if (pthread_create(&(datas->thid[i]), NULL, &thread_function, (void *)&datas->philos[i]) != 0)
		{
			ft_error(datas, 1, "pthread_create");
			return ;
		}
		i++;
	}
